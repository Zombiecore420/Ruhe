/*-----------------------------------------------------------------------------------
    Template Name: Hilani Logitics & Cargo html template
	...
	DelcoDoc = {
		...
		sliderTwo() {
			...
			bannerSliderTwo.slick({
				...
				arrows: true,
				prevArrow:
					'<span class="slick-arrow prev-arrow"><i class="fal fa-long-arrow-left"></i>Anterior</span>',
				nextArrow:
					'<span class="slick-arrow next-arrow">Siguiente<i class="fal fa-long-arrow-right"></i></span>',
				responsive: [
					{
						breakpoint: 768,
						settings: {
